...
M1.4 已补齐，范围和边界见[证据契约验收](m1-evidence-contracts.md)。剩余 M1.5：选曲/评估、派对状态、命令、事件及来源/主持/游戏端口；M1.6：扩展并完成全 M1 的 CI/验收。之后才进入 M2 评分与矩阵实现。本阶段不提供 `pnpm demo`，不勾选 #4 的整项 M1。
